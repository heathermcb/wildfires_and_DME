...
saveRDS(
  ...
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "getty_inpatient_cardioresp_evac_new.RDS"
  )
)
saveRDS(m4e,
        here(
...
saveRDS(
  ...
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "getty_emergency_cardioresp_evac_new.RDS"
  )
)
...
saveRDS(m1we,
        here(
          ...
          "proximity_analyses",
          "new_results_may28",
          "woolsey_outpatient_evac_new.RDS"
        ))
saveRDS(m2we,
        here(
          "analysis",
          "proximity_analyses",
          "new_results_may28",
          "woolsey_inpatient_evac_new.RDS"
        ))
saveRDS(
  m3we,
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "woolsey_inpatient_cardioresp_evac_new.RDS"
  )
)
saveRDS(m4we,
        here(
          ...
          "proximity_analyses",
          "new_results_may28",
          "woolsey_emergency_evac_new.RDS"
        ))
saveRDS(
  m5we,
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "woolsey_emergency_cardioresp_evac_new.RDS"
  )
)
...
saveRDS(
  ...
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "getty_inpatient_cardioresp_fire_new.RDS"
  )
)
saveRDS(m4f,
        here(
...
saveRDS(
  ...
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "getty_emergency_cardioresp_fire_new.RDS"
  )
)
...
saveRDS(m1wf,
        here(
          ...
          "proximity_analyses",
          "new_results_may28",
          "woolsey_outpatient_fire_new.RDS"
        ))
saveRDS(m2wf,
        here(
          "analysis",
          "proximity_analyses",
          "new_results_may28",
          "woolsey_inpatient_fire_new.RDS"
        ))
saveRDS(
  m3wf,
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "woolsey_inpatient_cardioresp_fire_new.RDS"
  )
)
saveRDS(m4wf,
        here(
          ...
          "proximity_analyses",
          "new_results_may28",
          "woolsey_emergency_fire_new.RDS"
        ))
saveRDS(
  m5wf,
  here(
    ...
    "proximity_analyses",
    "new_results_may28",
    "woolsey_emergency_cardioresp_fire_new.RDS"
  )
)
